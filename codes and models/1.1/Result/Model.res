...
lifetime=s:persistent
result=s:1
treepath=s:1D Results\Materials\material3\Dispersive\Eps'
files=s:material3_eps_re.sig
...
lifetime=s:persistent
result=s:1
treepath=s:1D Results\Materials\material3\Dispersive\Eps TangD
files=s:material3_eps_tgd.sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [1]\Loss per Material\Volume loss in material3
files=s:cVolume_loss_in_material3(1).sig
...
files=s:e-field (f=1)_2,1.m3d
files=s:e-field (f=1)_2,1_m3d.rex
...
files=s:h-field (f=1)_2,1.m3d
files=s:h-field (f=1)_2,1_m3d.rex
...
files=s:h-field (f=1)_2,1.m3d
files=s:h-field (f=1)_2,1_m3d_sct.rex
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [2]\Loss per Material\Volume loss in material3
files=s:cVolume_loss_in_material3(2).sig
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Mix 3D Results\1e-field (f=10) (1)
files=s:1e-field (f=10) (1).m3d
files=s:1e-field (f=10) (1).rex
ylabel=s:1e-field (f=10) (1)
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\0D Results\1e-field (f=10) (1)
files=s:1e-field (f=10) (1).rt0
files=s:1e-field (f=10) (1).rd0
title=s:1e-field (f=10) (1)
