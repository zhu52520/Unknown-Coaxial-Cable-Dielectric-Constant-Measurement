...
'# frequency = GHz
'# time = ns
'# frequency range: fmin = 0.5 fmax = 5
...
With Port 
     ...
     .Xrange "-3", "3" 
     .Yrange "-3", "3" 
     .Zrange "-1.3988810110277e-14", "-1.3988810110277e-14" 
     .XrangeAdd "0.0", "0.0" 
     .YrangeAdd "0.0", "0.0" 
     .ZrangeAdd "0.0", "0.0" 
     .SingleEnded "False" 
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickFaceFromId "component1:solid4", "1"
...
With Material 
     ...
     .MaterialUnit "Time", "ns"
     .MaterialUnit "Temperature", "Kelvin"
     .Epsilon "6.600134418482435"
     .Mu "1"
     .Sigma "0.055085851112927"
     .TanD "0.0"
     .TanDFreq "0.0"
     .TanDGiven "False"
     .TanDModel "ConstTanD"
